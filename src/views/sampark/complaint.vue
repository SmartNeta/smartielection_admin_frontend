<style type="text/css">
  ...
  @media (max-width: 1750px) and (min-width: 320px) {
    #complaintTable .table thead tr th, #complaintTable .table thead tr td, #complaintTable  .table tbody tr th, #complaintTable .table tbody tr td {
...
<template>
    ...
    <div class="app-card">
      <div class="app-card-content">
        ...
        <v-btn class="btn-success" @click="exportCSV" :to="file" >Export CSV</v-btn>
          <v-spacer></v-spacer>
          <v-text-field
            append-icon="search"
            label="Search"
        ...
        <v-data-table id="complaintTable"
  ...
  export default {
    ...
    methods: {
      ...
      deleteComplaint() {
       ...
       exportCSV(){
         samparkService.exportCSV().then((res) => {
      })
    },
    ...
    beforeMount() {
      ...
      samparkService.complaintByState().then((res) => {
