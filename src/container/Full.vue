  ...
  computed: {
    // computed property to get page breadcrumbs
      pageTitle() {
        ...
        if(this.$breadcrumbs[0].meta.title == "Samparaka" || this.$breadcrumbs[0].meta.title == "Survey Reports" || this.$breadcrumbs[0].meta.title == "Download Reports" || this.$breadcrumbs[0].meta.title == "Last Day Counting"){
